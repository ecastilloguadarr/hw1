...
DROP TABLE IF EXISTS moviesconnect;
...
SELECT movies.title, actors.name, characters.name FROM moviesconnect
INNER JOIN movies ON movies.id = moviesconnect.movie_id
INNER JOIN actors ON actors.id = moviesconnect.actor_id
INNER JOIN characters ON characters.id = moviesconnect.character_id; 